...
Of note is the fact that our dinamic programming algorithm does not make any assumptions on the nature of the probability distribuition and instead calculates the exact distribuition over a given network.
