...
\begin{figure}[htb]
  \begin{center}
		  \begin{tabular}[c]{c@{}c}
				...
				\vtop{\includegraphics[width=0.2\textwidth]{figures/calibration_legend.png}}
    \end{tabular}
  \end{center}
